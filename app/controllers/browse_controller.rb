  ...
  def taxon_lookup
    {
      ...
      "visas-immigration" => @@taxon["entering_staying_uk"],
      ...
      "business" => @@taxon["Business and industry"],
      # "setting-up" => "??", NO MATCH
      ...
      "abroad" => @@taxon["going_and_being_abroad"],
      "passports" => @@taxon["passports"],
      "living-abroad" => @@taxon["living_abroad"],
      "travel-abroad" => @@taxon["travel_abroad"],
    }
  end
  ...
  def taxon_filter_lookup
    {
      ...
      "inheritance-tax"              => "level_one_taxon=#{@@taxon["money"]}&level_two_taxon=#{@@taxon["personal_tax"]}&level_three_taxon=a5c88a77-03ba-4100-bd33-7ee2ce602dc8",
      "national-insurance"           => "level_one_taxon=#{@@taxon["money"]}&level_two_taxon=#{@@taxon["personal_tax"]}&level_three_taxon=cc195f93-4244-489a-97e9-22480113c770",
      "self-assessment"              => "level_one_taxon=#{@@taxon["money"]}&level_two_taxon=#{@@taxon["personal_tax"]}&level_three_taxon=24e91c04-21cb-479a-8f23-df0eaab31788",
      "vat"                          => "level_one_taxon=#{@@taxon["money"]}&level_two_taxon=#{@@taxon["business_tax"]}&level_three_taxon=e04c9a5c-88e8-46e5-91d9-add405e098fb",


      # Visas and immigration

      "visas-immigration"        => "level_one_taxon=#{@@taxon["entering_staying_uk"]}}",
      # "what-you-need-to-do"      => "", NO MATCH
      "eu-eea-commonwealth"      => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=#{@@taxon["rights_foreign_nationals_uk"]}&level_three_taxon=06e2928c-57b1-4b8d-a06e-3dde9ce63a6f",
      "tourist-short-stay-visas" => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=18c7918f-cde5-4e66-b5f4-cd15c33cc1cc",
      "student-visas"            => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=#{@@taxon["visas_entry_clearance"]}&level_three_taxon=51b699cf-d4dc-488c-a87e-070560d37791",
      "work-visas"               => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=#{@@taxon["rights_foreign_nationals_uk"]}&level_three_taxon=2170a0e2-603e-4385-b929-4b17b9ecc343",
      "family-visas"             => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=#{@@taxon["visas_entry_clearance"]}&level_three_taxon=d612c61e-22f4-4922-8bb2-b04b9202126e",
      "settle-in-the-uk"         => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=fef7e737-6f1a-4ef4-b844-aa24b630ad03",
      "asylum"                   => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=#{@@taxon["refugees_asylum_human_rights"]}",
      "immigration-appeals"      => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=#{@@taxon["refugees_asylum_human_rights"]}&level_three_taxon=e1d2032c-6a59-4a1a-919c-dc149847dffb",
      "arriving-in-the-uk"       => "level_one_taxon=#{@@taxon["entering_staying_uk"]}&level_two_taxon=18c7918f-cde5-4e66-b5f4-cd15c33cc1cc",


      # work jobs and pensions

      # Work > Working, jobs and pensions
      "working"                     => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}",
      "armed-forces"                => "level_one_taxon=#{@@taxon["defence_and_armed_forces"]}&level_two_taxon=8ff8cf05-a6e6-4757-a896-4fabd9f3229a",
      "finding-job"                 => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=21bfd8f6-3360-43f9-be42-b00002982d70",
      "time-off"                    => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=ebeaf804-c1b1-40cd-920f-319aa2b56ba3",
      "redundancies-dismissals"     => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=a4d954b4-3a64-488c-a0fc-fa91ecb8cf2b",
      "working-state-pension"       => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=f8b6d54b-cc94-4b32-aac4-8cd344087407",
      "workplace-personal-pensions" => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=a99fc39c-997a-4b1a-9e6d-8cf63a3100be",
      "contract-working-hours"      => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=23a712ff-23b3-4f5a-83f1-44ac679fe615",
      "tax-minimum-wage"            => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=ee1214e7-d14d-4975-9e08-b304642ab112",
      "rights-trade-unions"         => "level_one_taxon=#{@@taxon["work"]}&level_two_taxon=#{@@taxon["working"]}&level_three_taxon=0ee0e4df-7b06-47e4-8f1c-242603e16577",

      # business and self-employed

      # Business and industry
      "business" => "level_one_taxon=#{@@taxon["Business and industry"]}",
      #  "setting-up" => "??", NO MATCH
      "business-tax"               => "level_one_taxon=#{@@taxon["money"]}&level_two_taxon=#{@@taxon["business_tax"]}",
      "finance-support"            => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["running_a_business"]}&level_three_taxon=ccfc50f5-e193-4dac-9d78-50b3a8bb24c5",
      "limited-company"            => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["running_a_business"]}",
      "expenses-employee-benefits" => "level_one_taxon=#{@@taxon["money"]}&level_two_taxon=5605545e-03ca-4520-9519-163ea341bc86",
      "funding-debt"               => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["running_a_business"]}&level_three_taxon=a1119685-ffef-4417-a3e4-116014ad4523",
      "premises-rates"             => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["running_a_business"]}&level_three_taxon=68cc0b3c-7f80-4869-9dc7-b2ceef5f4f08",
      # "food" => "??", NO MATCH
      "imports" => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["importing_exporting"]}&level_three_taxon=d74faafc-781d-4087-8e0c-be4216180059",
      "exports" => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["importing_exporting"]}&level_three_taxon=efa9782b-a3d0-4ca0-9c92-3b89748175b7",
      "licences" => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["running_a_business"]}&level_three_taxon=8758d11e-3c6f-4b81-99e6-791a99e44363",
      # "selling-closing" => "", NOT FOUND
      "sales-good-services-data" => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["business_regulation"]}&level_three_taxon=c39ac533-be2c-4460-93ba-e656793568ef",
      "childcare-providers"      => "level_one_taxon=#{@@taxon["childcare_parenting"]}&level_two_taxon=#{@@taxon["childcare_and_early_years"]}&level_three_taxon=18cb575a-45a0-4ab8-8bff-12c48a2ee8d4",
      "farming"                  => "level_one_taxon=#{@@taxon["environment"]}&level_two_taxon=#{@@taxon["food_and_farming"]}&level_three_taxon=e2559668-cf36-47fc-8a77-2e760e12a812",
      "manufacturing"            => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=d34ba9b3-28d8-40d5-a2d3-f52d216c2590",
      "intellectual-property"    => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["business_regulation"]}&level_three_taxon=d949275c-88f8-4623-a44b-eb3706651e10",
      "waste-environment"        => "level_one_taxon=#{@@taxon["environment"]}&level_two_taxon=#{@@taxon["waste_and_recycling"]}&level_three_taxon=090c16bc-7b3e-42cd-b93c-645ab43fae30",
      "science"                  => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["science_and_innovation"]}&level_three_taxon=429bf677-b514-4c10-8a89-c0eee4acc7ec",
      "generating-energy"        => "level_one_taxon=#{@@taxon["Business and industry"]}&level_two_taxon=#{@@taxon["business_regulation"]}&level_three_taxon=092c86a5-717e-4bea-be43-4a5d8695a113",
      "maritime"                 => "level_one_taxon=#{@@taxon["transport"]}&level_two_taxon=4a9ab4d7-0d03-4c61-9e16-47787cbf53cd",


      # Passports, travel and living abroad
      "abroad" => "level_one_taxon=#{@@taxon["going_and_being_abroad"]}",
      "passports" => "level_one_taxon=#{@@taxon["going_and_being_abroad"]}&level_two_taxon=#{@@taxon["passports"]}",
      "living-abroad" => "level_one_taxon=#{@@taxon["going_and_being_abroad"]}&level_two_taxon=#{@@taxon["living_abroad"]}",
      "travel-abroad" => "level_one_taxon=#{@@taxon["going_and_being_abroad"]}&level_two_taxon=#{@@taxon["travel_abroad"]}",
    }
  end
